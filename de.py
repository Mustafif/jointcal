...
for idx, config in enumerate(dataset_configs):
    ...
    try:
        ...
        Rt_true = mc(true_vals[0], true_vals[1], true_vals[2], true_vals[3], true_vals[4])
        ...
        Rt_initial = mc(initial_guess[0], initial_guess[1], initial_guess[2], initial_guess[3], initial_guess[4])
        ...
        Rt_final = mc(params_scipy[0], params_scipy[1], params_scipy[2], params_scipy[3], params_scipy[4])
        ...
        individual_filename = results_dir / f"params_{dataset_name}_l2_{l2_error:.8f}.json"
...
# Summary statistics
successful_runs = sum(1 for result in all_results.values()
...
if successful_runs > 0:
    ...
    l2_errors = [result['metrics']['l2_error'] for result in all_results.values()
